...
equation <- paste0("ln_bodymass = ", round(intercept, 4), 
                   " + ", round(ln_midshaft_coef, 4), " * ln_length", 
                   " + ", round(ln_length_coef, 4), " * ln_proximal")
